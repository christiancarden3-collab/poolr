...
export const SCORING_RULES = {
  ...
  winnerPlusOne: 2,     // Ganador + un marcador correcto
  correctResult: 1,     // Ganador o empate acertado (winner or tie)
  correctQualifier: 2,  // Clasificado correcto (picking who advances)
  
  // Knockout winner bonus (flat points, not multipliers)
  r32Bonus: 2,    // Ganador dieciseisavos
  r16Bonus: 3,    // Ganador octavos
  qfBonus: 4,     // Ganador cuartos
  sfBonus: 5,     // Ganador semifinal
  
  // Special picks
  champion: 10,     // Campeón
  runnerUp: 7,      // Subcampeón
  topScorer: 5,     // Máximo goleador
  bestKeeper: 5,    // Mejor portero FIFA
}
