    ...
    <>
      ...
      <nav>
        ...
        <div className="nav-items">
          ...
          <a href="#" className="nav-item">Results</a>
        </div>
      ...
      <style jsx>{`
        ...
        .pitch-surface {
          position: absolute;
          inset: 0;
          background: repeating-linear-gradient(0deg, rgba(10,28,10,0.75) 0px, rgba(10,28,10,0.75) 38px, rgba(14,36,14,0.75) 38px, rgba(14,36,14,0.75) 76px);
          border: 2px solid rgba(255,255,255,0.08);
        }
        .pitch-lines {
          position: absolute;
          inset: 0;
          background: linear-gradient(90deg, transparent 49.4%, rgba(255,255,255,0.12) 49.4%, rgba(255,255,255,0.12) 50.6%, transparent 50.6%),
                      linear-gradient(0deg, transparent 49.4%, rgba(255,255,255,0.12) 49.4%, rgba(255,255,255,0.12) 50.6%, transparent 50.6%);
        }
        .pitch-circle {
          position: absolute;
          top: 50%;
        ...
        .pitch-glow {
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 70% 40% at 50% 60%, rgba(201,168,76,0.06), transparent 70%);
        }
        .pitch-fade {
          position: absolute;
          inset: 0;
          background: linear-gradient(to bottom, rgba(10,12,16,0.15) 0%, rgba(10,12,16,0.0) 40%, rgba(10,12,16,0.5) 100%);
        }
        ...
        .lb-cols {
          display: grid;
          grid-template-columns: 36px 1fr 56px 44px;
        ...
        .scoring-section-label:first-child {
          border-top: none;
        }
        .scoring-table {
          width: 100%;
        ...
        @media (max-width: 900px) {
          ...
          .col-side { padding: 2rem 0; border-top: 1px solid var(--line); }
