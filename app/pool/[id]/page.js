  ...
  return (
    <AppShell user={user} showPageHeader={false}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="invite-link-box">
                    ...
                    <button onClick={() => { navigator.clipboard.writeText(`https://pickpoolr.com/join/${pool.invite_code}`); alert('Link copied!'); }}>Copy</button>
                  </div>
                  <div className="share-buttons">
                    ...
                    <a 
                      href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://pickpoolr.com/join/${pool.invite_code}`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
      ...
      <style jsx global>{`
        ...
        .share-btn.more { background: var(--bg3); color: var(--f2); }
